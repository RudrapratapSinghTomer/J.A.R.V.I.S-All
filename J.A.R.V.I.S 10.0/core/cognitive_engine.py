...
class TrueBackendThinkingEngine:
    ...
    def analyze_and_plan(self, query: str, system_context: str, past_episodes: List[dict]) -> dict:
        ...
        prompt = (
            ...
            "        \"command_or_action\": \"The action to perform. If type=vision, use 'capture_and_analyze <prompt>' for taking a new photo, OR 'analyze_existing <image_path> <prompt>' for reading/analyzing an existing file. If type=browser, use e.g. 'search <term>' or 'navigate to <url>'\",\n"
            "        \"dependencies\": []\n"
            "      }\n"
            "    ]\n"
            "  },\n"
