...
# J.A.R.V.I.S. Dynamic Protection: Block ALL deletes if JARVIS_RESTRICT_DELETE is set
if os.getenv("JARVIS_RESTRICT_DELETE", "1") == "1":
    HARDLINE_PATTERNS.append((r'\b(rm|del|erase|shred)\s+', "Dynamic 'No-Delete' policy is active"))
